...
//  AppIntent-Shortcuts
//
//  Created by Mohit Sharma on 10/04/25.
//
    ...
    var body: some View {
        NavigationStack {
            ...
            .overlay {
                if memories.isEmpty {
                    VStack {
                        Text("No memories yet.").font(.headline)
                        Text("Tap the plus (+) button to add your first memory.").foregroundStyle(Color.secondary)
                    }
                    .padding(15)
                }
            }
